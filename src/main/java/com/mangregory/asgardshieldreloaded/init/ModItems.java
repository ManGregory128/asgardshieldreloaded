...
public class ModItems
{
    ...
    public static final ItemAsgardShield WOODEN_SHIELD = new ItemAsgardShield("wooden_shield", MATERIAL_NEWWOOD, ASRConfig.SHIELDS.WOODEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.WOODEN_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_WOODEN_SHIELD = new ItemAsgardShield("gilded_wooden_shield", MATERIAL_NEWWOOD, ASRConfig.SHIELDS.GILDED_WOODEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_WOODEN_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield STONE_SHIELD = new ItemAsgardShield("stone_shield", MATERIAL_NEWSTONE, ASRConfig.SHIELDS.STONE_SHIELD_DURABILITY, ASRConfig.SHIELDS.STONE_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_STONE_SHIELD = new ItemAsgardShield("gilded_stone_shield", MATERIAL_NEWSTONE, ASRConfig.SHIELDS.GILDED_STONE_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_STONE_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield IRON_SHIELD = new ItemAsgardShield("iron_shield", MATERIAL_NEWIRON, ASRConfig.SHIELDS.IRON_SHIELD_DURABILITY, ASRConfig.SHIELDS.IRON_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_IRON_SHIELD = new ItemAsgardShield("gilded_iron_shield", MATERIAL_NEWIRON, ASRConfig.SHIELDS.GILDED_IRON_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_IRON_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GOLDEN_SHIELD = new ItemAsgardShield("golden_shield", MATERIAL_NEWGOLD, ASRConfig.SHIELDS.GOLDEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.GOLDEN_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield BLESSED_GOLDEN_SHIELD = new ItemAsgardShield("blessed_golden_shield", MATERIAL_NEWGOLD, ASRConfig.SHIELDS.BLESSED_GOLDEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.BLESSED_GOLDEN_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield DIAMOND_SHIELD = new ItemAsgardShield("diamond_shield", MATERIAL_NEWDIAMOND, ASRConfig.SHIELDS.DIAMOND_SHIELD_DURABILITY, ASRConfig.SHIELDS.DIAMOND_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_DIAMOND_SHIELD = new ItemAsgardShield("gilded_diamond_shield", MATERIAL_NEWDIAMOND, ASRConfig.SHIELDS.GILDED_DIAMOND_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_DIAMOND_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield NETHERQUARTZ_SHIELD = new ItemAsgardShield("netherquartz_shield", MATERIAL_NETHERQUARTZ, ASRConfig.SHIELDS.NETHERQUARTZ_SHIELD_DURABILITY, ASRConfig.SHIELDS.NETHERQUARTZ_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_NETHERQUARTZ_SHIELD = new ItemAsgardShield("gilded_netherquartz_shield", MATERIAL_NETHERQUARTZ, ASRConfig.SHIELDS.GILDED_NETHERQUARTZ_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_NETHERQUARTZ_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield PATCHWORK_SHIELD = new ItemAsgardShield("patchwork_shield", MATERIAL_PATCHWORK, ASRConfig.SHIELDS.PATCHWORK_SHIELD_DURABILITY, ASRConfig.SHIELDS.PATCHWORK_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_PATCHWORK_SHIELD = new ItemAsgardShield("gilded_patchwork_shield", MATERIAL_PATCHWORK, ASRConfig.SHIELDS.GILDED_PATCHWORK_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_PATCHWORK_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield SKULL_SHIELD = new ItemAsgardShield("skull_shield", MATERIAL_SKULL, ASRConfig.SHIELDS.SKULL_SHIELD_DURABILITY, ASRConfig.SHIELDS.SKULL_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_SKULL_SHIELD = new ItemAsgardShield("gilded_skull_shield", MATERIAL_SKULL, ASRConfig.SHIELDS.GILDED_SKULL_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_SKULL_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield ENDER_SHIELD = new ItemAsgardShield("ender_shield", MATERIAL_ENDER, ASRConfig.SHIELDS.ENDER_SHIELD_DURABILITY, ASRConfig.SHIELDS.ENDER_SHIELD_MAXUSEDURATION, 0);
    public static final ItemAsgardShield GILDED_ENDER_SHIELD = new ItemAsgardShield("gilded_ender_shield", MATERIAL_ENDER, ASRConfig.SHIELDS.GILDED_ENDER_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_ENDER_SHIELD_MAXUSEDURATION, 0);
}