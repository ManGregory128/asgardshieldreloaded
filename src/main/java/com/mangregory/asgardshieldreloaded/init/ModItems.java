...
public class ModItems
{
    ...
    public static final Item.ToolMaterial MATERIAL_PATCHWORK = EnumHelper.addToolMaterial("material_patchwork", 0, ASRConfig.SWORDS.PATCHWORK_GIANT_SWORD_DURABILITY, 2.0F, (float) ASRConfig.SWORDS.PATCHWORK_GIANT_SWORD_DAMAGE - 4, 15);
    ...
    public static final ItemAsgardShield PATCHWORK_SHIELD = new ItemAsgardShield("patchwork_shield", ASRConfig.SHIELDS.PATCHWORK_SHIELD_DURABILITY, ASRConfig.SHIELDS.PATCHWORK_SHIELD_MAXUSEDURATION);
    public static final ItemAsgardShield GILDED_PATCHWORK_SHIELD = new ItemAsgardShield("gilded_patchwork_shield", ASRConfig.SHIELDS.GILDED_PATCHWORK_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_PATCHWORK_SHIELD_MAXUSEDURATION);
