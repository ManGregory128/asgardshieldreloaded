...
public class ModItems
{
    ...
    public static final ItemAsgardShield GOLDEN_SHIELD = new ItemAsgardShield("golden_shield", MATERIAL_NEWGOLD, ASRConfig.SHIELDS.GOLDEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.GOLDEN_SHIELD_MAXUSEDURATION, 14475346);
    public static final ItemAsgardShield BLESSED_GOLDEN_SHIELD = new ItemAsgardShield("blessed_golden_shield", MATERIAL_NEWGOLD, ASRConfig.SHIELDS.BLESSED_GOLDEN_SHIELD_DURABILITY, ASRConfig.SHIELDS.BLESSED_GOLDEN_SHIELD_MAXUSEDURATION, 14475346);
