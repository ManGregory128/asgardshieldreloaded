...
public class ModItems
{
    ...
    public static final ItemAsgardShield WOODEN_SHIELD = new ItemAsgardShield("wooden_shield", 118, 200, 200);
    public static final ItemAsgardShield GILDED_WOODEN_SHIELD = new ItemAsgardShield("gilded_wooden_shield", 246, 200, 200);
    public static final ItemAsgardShield STONE_SHIELD = new ItemAsgardShield("stone_shield", 131, 200, 200);
    public static final ItemAsgardShield GILDED_STONE_SHIELD = new ItemAsgardShield("gilded_stone_shield", 259, 200, 200);
    public static final ItemAsgardShield IRON_SHIELD = new ItemAsgardShield("iron_shield", 250, 200, 200);
    public static final ItemAsgardShield GILDED_IRON_SHIELD = new ItemAsgardShield("gilded_iron_shield", 378, 200, 200);
    public static final ItemAsgardShield DIAMOND_SHIELD = new ItemAsgardShield("diamond_shield", 780, 200, 200);
    public static final ItemAsgardShield GILDED_DIAMOND_SHIELD = new ItemAsgardShield("gilded_diamond_shield", 908, 200, 200);
    public static final ItemAsgardShield NETHERQUARTZ_SHIELD = new ItemAsgardShield("netherquartz_shield", 369, 200, 200);
    public static final ItemAsgardShield GILDED_NETHERQUARTZ_SHIELD = new ItemAsgardShield("gilded_netherquartz_shield", 497, 200, 200);
    public static final ItemAsgardShield SKULL_SHIELD = new ItemAsgardShield("skull_shield", 174, 200, 200);
    public static final ItemAsgardShield GILDED_SKULL_SHIELD = new ItemAsgardShield("gilded_skull_shield", 302, 200, 200);
    public static final ItemAsgardShield ENDER_SHIELD = new ItemAsgardShield("ender_shield", 435, 200, 200);
    public static final ItemAsgardShield GILDED_ENDER_SHIELD = new ItemAsgardShield("gilded_ender_shield", 563, 200, 200);
