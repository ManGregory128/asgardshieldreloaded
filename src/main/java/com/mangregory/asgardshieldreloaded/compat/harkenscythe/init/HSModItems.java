...
public class HSModItems
{
    ...
    public static void init()
    {
        ...
        BIOMASS_SHIELD = new ItemAsgardShield("biomass_shield", MATERIAL_BIOMASS, ASRConfig.SHIELDS.BIOMASS_SHIELD_DURABILITY, ASRConfig.SHIELDS.BIOMASS_SHIELD_MAXUSEDURATION, 0);
        GILDED_BIOMASS_SHIELD = new ItemAsgardShield("gilded_biomass_shield", MATERIAL_BIOMASS, ASRConfig.SHIELDS.GILDED_BIOMASS_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_BIOMASS_SHIELD_MAXUSEDURATION, 0);
        LIVINGMETAL_SHIELD = new ItemAsgardShield("livingmetal_shield", MATERIAL_LIVINGMETAL, ASRConfig.SHIELDS.LIVINGMETAL_SHIELD_DURABILITY, ASRConfig.SHIELDS.LIVINGMETAL_SHIELD_MAXUSEDURATION, 0);
        GILDED_LIVINGMETAL_SHIELD = new ItemAsgardShield("gilded_livingmetal_shield", MATERIAL_LIVINGMETAL, ASRConfig.SHIELDS.GILDED_LIVINGMETAL_SHIELD_DURABILITY, ASRConfig.SHIELDS.GILDED_LIVINGMETAL_SHIELD_MAXUSEDURATION, 0);
    }
}