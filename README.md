...
![GitHub Workflow Status (with event)](https://img.shields.io/github/actions/workflow/status/ManGregory128/asgardshieldreloaded/build.yml)
...
**Shields** (available in 1.12.2 and partially available in 1.19.4 and 1.20-1.21) have special perks and weaknesses, giving each shield its unique purpose. They‘re crafted using leather and six pieces of the respective material and can be upgraded with gold for improved stats.