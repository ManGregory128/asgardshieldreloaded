        ...
        DIAMOND_GIANT_SWORD = registerItem("diamond_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .enchantable(AsgardShieldToolMaterials.ALTDIAMOND.enchantmentValue())
        ...
        IRON_GIANT_SWORD = registerItem("iron_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ALTIRON.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        GOLDEN_GIANT_SWORD = registerItem("golden_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ALTGOLD.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        COPPER_GIANT_SWORD = registerItem("copper_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ALTCOPPER.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        NETHERITE_GIANT_SWORD = registerItem("netherite_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .fireResistant()
                                .enchantable(AsgardShieldToolMaterials.ALTNETHERITE.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        STONE_GIANT_SWORD = registerItem("stone_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ALTSTONE.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        WOODEN_GIANT_SWORD = registerItem("wooden_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ALTWOOD.enchantmentValue())
                                .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(
        ...
        ENDER_GIANT_SWORD = registerItem("ender_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.ENDTOOLMATERIAL.enchantmentValue())
        ...
        NETHERQUARTZ_GIANT_SWORD = registerItem("netherquartz_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.NQ_TOOLMATERIAL.enchantmentValue())
        ...
        SKULL_GIANT_SWORD = registerItem("skull_giant_sword",
                () -> new GiantSwordItem(
                        new Item.Properties()
                                ...
                                .component(DataComponents.BLOCKS_ATTACKS, BLOCKS_ATTACKS)
                                .enchantable(AsgardShieldToolMaterials.SKULL_TOOLMATERIAL.enchantmentValue())
